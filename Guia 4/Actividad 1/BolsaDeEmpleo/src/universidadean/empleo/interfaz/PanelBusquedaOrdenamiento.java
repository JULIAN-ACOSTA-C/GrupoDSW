...
public class PanelBusquedaOrdenamiento extends JPanel implements ActionListener {
    ...
    private static final String BUSCAR_BINARIO = "BuscarBinario";
    ...
    /**
     * Es el botón para ordenar la lista de aspirantes por nombre
     */
    ...
    /**
     * Es el botón para ordenar lista de aspirantes por profesión
     */
     ...
     * Es el botón para ordenar la lista de aspirantes por nombre
     */
    private JButton botonBuscarBinario;
    ...
    public PanelBusquedaOrdenamiento(InterfazBolsaDeEmpleo interfaz) {
        ...
        botonBuscarBinario = new JButton("Buscar Aspirante (B. Binaria)");
        botonBuscarBinario.setActionCommand(BUSCAR_BINARIO);
        botonBuscarBinario.addActionListener(this);
        gbc.gridy = 5;
        add(botonBuscarBinario, gbc);
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if(BUSCAR_BINARIO.equals(comando)){
